  ...
  return (
    <>
      <div className="sidebar-header">
        ...
        <div className=" col-12 flex flex-row gap-2 align-items-center justify-content-center">
          <div>
            <img
                src="/demo/images/qrder/sample-qrcode.png"
                alt="sample qr code"
                className="h-4rem w-4rem ml-3 mt-2"
            />
          </div>
            <div className="text-6xl text-black-300 font-medium">Qrder</div>
        </div>
        <button
